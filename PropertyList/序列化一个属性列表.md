...
有关`CFPropertyListCreateFromXMLData`的可变性选项参数的讨论，请参阅[在Objective-C中保存和恢复一个属性列表](#SavingandRestoringaPropertyListinObjective)中的`propertyListFromData:mutabilityOption:format:errorDescription:`方法的相应参数的讨论。
